package com._basebase.base.ui.recyclerimp;
 ...
 * @author roy.xing
 * @date 2019-05-06
 * https://github.com/RoyXing/recyclerview/blob/master/app/src/main/java/com/xingzy/recyclerview/Recycler.java
 */
public class RecyclerViewImp extends ViewGroup {

    /**
     * 缓存已经加载到屏幕上的View,这些View不存在回收池中，需要集合表示，方便后续查找和移除
     */
    private List<View> viewList;
    private int key_tag = 0xff;
    /**
     * 记录在Y轴上滑动的距离
     */
    ...
    public RecyclerViewImp(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyclerViewImp(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void removeView(View view) {
        ...
        recycler.put(view, (int) view.getTag(key_tag));
    }
